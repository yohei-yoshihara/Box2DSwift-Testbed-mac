...
class Gear: TestCase {
  override class var title: String { "Gear" }
  ...
  let row1 = createLabelField(labelWithString: "theta1 + 0.0 * theta2 = 0.0")
  let row2 = createLabelField(labelWithString: "theta1 + 0.0 * theta2 = 0.0")
  ...
  override func step() {
    ...
    row1.stringValue = String(format: "theta1 + %4.2f * theta2 = %4.2f", ratio, value)
    
    ratio = joint5.ratio
    value = joint2.jointAngle + ratio * joint3.jointTranslation
    row2.stringValue = String(format: "theta1 + %4.2f * theta2 = %4.2f", ratio, value)
  }
