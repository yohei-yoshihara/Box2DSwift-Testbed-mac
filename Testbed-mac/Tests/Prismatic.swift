...
class Prismatic: TestCase {
  override class var title: String { "Prismatic" }
  ...
  override func step() {
    ...
    field.stringValue = String(format: "Motor Force = %4.0f", force)
  }
  
  var _customView: NSView?
  let label = NSTextField(labelWithString: "Motor Force:")
  let field = NSTextField(labelWithString: "0.0")
